...
<div class="inner-wrapper">
	...
	<form class="form" action="signup.php" method="POST">
		...
		<input type ="number" class="form-control"  name="mob_no" placeholder="Enter your mobile no "requrired>
	</div>
	<div class="form-group">
...
$C_Password2=$_POST['password2'];
	...
	$sql="insert into customer (Name,Email,Mob_no,Password1,Password2)values('$C_Name','$C_Email','$C_Mob_no','$C_Password1','$C_Password2')";
